    ...
    const init = async () => {
      try {
        ...
        try {
          ...
          console.error(error)
          console.error('Permissions API / "microphone" query unsupported (e.g. Safari) — treat as not granted so we still resolve real device IDs below.')
        }
          ...
          <div className="govuk-grid-row">
            <div className="govuk-grid-column-full">
              <div className="govuk-form-group">
                <fieldset className="govuk-fieldset h-55 govuk-!-margin-top-9" aria-describedby="recordMeeting-hint">
                  <div className="govuk-radios govuk-radios--inline flex" data-module="govuk-radios">
                    <div className="govuk-radios__item new-recording__radio-item flex-1">
                      ...
                      <label className="govuk-label govuk-radios__label" htmlFor="in-person">
                        <Mic className="size-7 mb-2" />
                    ...
                    <div className="govuk-radios__item new-recording__radio-item flex-1">
                      <input className="govuk-radios__input" id="virtual-meeting" name="recordMeeting" type="radio" value="virtual-meeting" checked={mode === 'virtual-meeting'} onChange={() => setMode('virtual-meeting')} />
                      <label className="govuk-label govuk-radios__label" htmlFor="virtual-meeting">
                        <Video className="size-7 mb-2" />
                        <h2 className="govuk-heading-m">
                          Virtual meeting
                        </h2>
                        <p className="govuk-body">
                    ...
                    <div className="govuk-radios__item new-recording__radio-item flex-1">
                      <input className="govuk-radios__input" id="upload-file" name="recordMeeting" type="radio" value="upload-file" checked={mode === 'upload-file'} onChange={() => setMode('upload-file')} />
                      <label className="govuk-label govuk-radios__label" htmlFor="upload-file">
                        <Upload className="size-7 mb-2" />
                        <h2 className="govuk-heading-m">
                          Upload a file
                        </h2>
                        <p className="govuk-body">
                ...
                <button className="govuk-button govuk-button--start govuk-!-margin-top-6" data-module="govuk-button" onClick={() => setStarted(true)}>
                  {buttonLabels[mode]}
