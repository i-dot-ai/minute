...
import { GeneratingView } from '@/components/transcriptions/generating-view'
...
export default function Home() {
  ...
  // Virtual meeting: open the screen-share picker straight from the click (a real
  // user gesture, which getDisplayMedia requires) so the modal appears over the
  // home page. Only switch to the recorder once a tab has actually been shared.
      ...
      <div className="govuk-width-container govuk-main-wrapper">
        ...
        <div className="govuk-grid-row">
          <div className="govuk-grid-column-full">
            ...
            {generatingId ? (
              <GeneratingView transcriptionId={generatingId} />
            ) : (
              <>
                  ...
                  <>
                    {mode === 'in-person' && (
                      <MicRecorderForm
                        ...
                        onStarted={(id) => setGeneratingId(id)}
                      />
                    )}
