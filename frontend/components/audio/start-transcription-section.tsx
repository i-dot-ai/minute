    ...
    <>
      <div className="govuk-grid-row">
        <div className="govuk-grid-column-one-third">
          ...
          <p className="govuk-body">Set the style for your meeting summary</p>
        </div>
      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent wideModal>
          ...
          <TemplateSelect value={draftTemplate} onChange={setDraftTemplate} />
          <DialogFooter>
            <button
              type="button"
            ...
            <button type="button" className="govuk-button" onClick={handleDone}>
              Select template
            </button>
          </DialogFooter>
        </DialogContent>
      ...
      <div className="govuk-grid-row">
        ...
        <div className="govuk-grid-column-two-thirds">
          ...
          {isPending && <strong className="govuk-tag">Uploading...</strong>}
        </div>
      </div>
    </>
  )
