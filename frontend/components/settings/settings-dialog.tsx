...
export function SettingsDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogTitle className="govuk-heading-l">Settings</DialogTitle>
        {user ? (
          <SettingsForm user={user} onSaved={() => setOpen(false)} />
        ) : (
...
export function SettingsForm({
  ...
  const onSubmit = useCallback(
    ...
    [mutateAsync, onSaved, queryClient]
  )
      ...
      <div className="govuk-form-group">
        ...
        >
          <legend className="govuk-fieldset__legend govuk-fieldset__legend--s">
            <h2 className="govuk-fieldset__heading">Data Retention Period</h2>
          </legend>
