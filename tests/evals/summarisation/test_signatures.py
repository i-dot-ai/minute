...
def test_contract_judge_rating_signature_extends_dspy_signature():
...
def test_contract_judge_rating_signature_has_required_fields():
...
def test_contract_judge_rating_signature_rating_field_type():
